...
class KolmogorovTemp(object, metaclass=abc.ABCMeta):
    """
...
class GaussianTempWind(object, metaclass=abc.ABCMeta):
    """
...
class KolmogorovTempWind(object, metaclass=abc.ABCMeta):
    """
...
class VonKarmanTempWind(object, metaclass=abc.ABCMeta):
    """
